...
class GeneralViewController: UIViewController
{
    ...
    init(string: String)
    {
        let data: [String] = ["Tune-Up", "Check Engine Light Service", "Brake Service", "Body Work", "Oil Change"]
        one = UIButton()
        two = UIButton()
        three = UIButton()
        four = UIButton()
        ...
        exit.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(generalTap(_:))))
